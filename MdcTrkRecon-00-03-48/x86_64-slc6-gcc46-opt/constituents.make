...
#cmt_local_tagfile = $(MdcTrkRecon_tag).make
cmt_local_tagfile = $(bin)$(MdcTrkRecon_tag).make
...
cmt_local_setup_MdcTrkReconLib = $(bin)setup_MdcTrkReconLib$$$$.make
...
MdcTrkReconLib_extratags = -tag_add=target_MdcTrkReconLib

#$(cmt_local_tagfile_MdcTrkReconLib) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_MdcTrkReconLib) ::
else
$(cmt_local_tagfile_MdcTrkReconLib) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_MdcTrkReconLib); then /bin/rm -f $(cmt_local_tagfile_MdcTrkReconLib); fi ; \
	  $(cmtexe) -tag=$(tags) $(MdcTrkReconLib_extratags) build tag_makefile >>$(cmt_local_tagfile_MdcTrkReconLib)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_MdcTrkReconLib)"; \
	  test ! -f $(cmt_local_setup_MdcTrkReconLib) || \rm -f $(cmt_local_setup_MdcTrkReconLib); \
	  trap '\rm -f $(cmt_local_setup_MdcTrkReconLib)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(MdcTrkReconLib_extratags) show setup >$(cmt_local_setup_MdcTrkReconLib) && \
	  if [ -f $(cmt_final_setup_MdcTrkReconLib) ] && \
	    \cmp -s $(cmt_final_setup_MdcTrkReconLib) $(cmt_local_setup_MdcTrkReconLib); then \
	    \rm $(cmt_local_setup_MdcTrkReconLib); else \
	    \mv -f $(cmt_local_setup_MdcTrkReconLib) $(cmt_final_setup_MdcTrkReconLib); fi
...
not_MdcTrkReconLib_dependencies = { n=0; for p in $?; do m=0; for d in $(MdcTrkReconLib_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
MdcTrkReconLibdirs :
	@if test ! -d $(bin)MdcTrkReconLib; then $(mkdir) -p $(bin)MdcTrkReconLib; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)MdcTrkReconLib
else
MdcTrkReconLibdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)MdcTrkReconLib
#
#$(cmt_local_MdcTrkReconLib_makefile) :: $(MdcTrkReconLib_dependencies) $(cmt_local_tagfile_MdcTrkReconLib) build_library_links dirs MdcTrkReconLibdirs
#else
#$(cmt_local_MdcTrkReconLib_makefile) :: $(MdcTrkReconLib_dependencies) $(cmt_local_tagfile_MdcTrkReconLib) build_library_links dirs
#endif
#else
#$(cmt_local_MdcTrkReconLib_makefile) :: $(cmt_local_tagfile_MdcTrkReconLib)
#endif

ifdef cmt_MdcTrkReconLib_has_target_tag

ifndef QUICK
$(cmt_local_MdcTrkReconLib_makefile) : $(MdcTrkReconLib_dependencies) build_library_links
	$(echo) "(constituents.make) Building MdcTrkReconLib.make"; \
	  $(cmtexe) -tag=$(tags) $(MdcTrkReconLib_extratags) build constituent_config -out=$(cmt_local_MdcTrkReconLib_makefile) MdcTrkReconLib
else
$(cmt_local_MdcTrkReconLib_makefile) : $(MdcTrkReconLib_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_MdcTrkReconLib) ] || \
	  [ ! -f $(cmt_final_setup_MdcTrkReconLib) ] || \
	  $(not_MdcTrkReconLib_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building MdcTrkReconLib.make"; \
	  $(cmtexe) -tag=$(tags) $(MdcTrkReconLib_extratags) build constituent_config -out=$(cmt_local_MdcTrkReconLib_makefile) MdcTrkReconLib; \
	  fi
endif
...
$(cmt_local_MdcTrkReconLib_makefile) : $(MdcTrkReconLib_dependencies) build_library_links
	$(echo) "(constituents.make) Building MdcTrkReconLib.make"; \
	  $(cmtexe) -f=$(bin)MdcTrkReconLib.in -tag=$(tags) $(MdcTrkReconLib_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_MdcTrkReconLib_makefile) MdcTrkReconLib
else
$(cmt_local_MdcTrkReconLib_makefile) : $(MdcTrkReconLib_dependencies) $(cmt_build_library_linksstamp) $(bin)MdcTrkReconLib.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_MdcTrkReconLib) ] || \
	  [ ! -f $(cmt_final_setup_MdcTrkReconLib) ] || \
	  $(not_MdcTrkReconLib_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(MdcTrkReconLib_extratags) build constituent_makefile -out=$(cmt_local_MdcTrkReconLib_makefile) MdcTrkReconLib

MdcTrkReconLib :: $(MdcTrkReconLib_dependencies) $(cmt_local_MdcTrkReconLib_makefile) dirs MdcTrkReconLibdirs
	$(echo) "(constituents.make) Starting MdcTrkReconLib"
	@if test -f $(cmt_local_MdcTrkReconLib_makefile); then \
	  $(MAKE) -f $(cmt_local_MdcTrkReconLib_makefile) MdcTrkReconLib; \
	  fi
#	@$(MAKE) -f $(cmt_local_MdcTrkReconLib_makefile) MdcTrkReconLib
	$(echo) "(constituents.make) MdcTrkReconLib done"

clean :: MdcTrkReconLibclean

MdcTrkReconLibclean :: $(MdcTrkReconLibclean_dependencies) ##$(cmt_local_MdcTrkReconLib_makefile)
	$(echo) "(constituents.make) Starting MdcTrkReconLibclean"
	@-if test -f $(cmt_local_MdcTrkReconLib_makefile); then \
	  $(MAKE) -f $(cmt_local_MdcTrkReconLib_makefile) MdcTrkReconLibclean; \
	fi
	$(echo) "(constituents.make) MdcTrkReconLibclean done"
#	@-$(MAKE) -f $(cmt_local_MdcTrkReconLib_makefile) MdcTrkReconLibclean

##	  /bin/rm -f $(cmt_local_MdcTrkReconLib_makefile) $(bin)MdcTrkReconLib_dependencies.make

install :: MdcTrkReconLibinstall

MdcTrkReconLibinstall :: $(MdcTrkReconLib_dependencies) $(cmt_local_MdcTrkReconLib_makefile)
	$(echo) "(constituents.make) Starting install MdcTrkReconLib"
	@-$(MAKE) -f $(cmt_local_MdcTrkReconLib_makefile) install
	$(echo) "(constituents.make) install MdcTrkReconLib done"

uninstall : MdcTrkReconLibuninstall

$(foreach d,$(MdcTrkReconLib_dependencies),$(eval $(d)uninstall_dependencies += MdcTrkReconLibuninstall))

MdcTrkReconLibuninstall : $(MdcTrkReconLibuninstall_dependencies) ##$(cmt_local_MdcTrkReconLib_makefile)
	$(echo) "(constituents.make) Starting uninstall MdcTrkReconLib"
	@if test -f $(cmt_local_MdcTrkReconLib_makefile); then \
	  $(MAKE) -f $(cmt_local_MdcTrkReconLib_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_MdcTrkReconLib_makefile) uninstall
	$(echo) "(constituents.make) uninstall MdcTrkReconLib done"

remove_library_links :: MdcTrkReconLibuninstall
...
cmt_local_setup_MdcTrkRecon = $(bin)setup_MdcTrkRecon$$$$.make
...
MdcTrkRecon_extratags = -tag_add=target_MdcTrkRecon

#$(cmt_local_tagfile_MdcTrkRecon) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_MdcTrkRecon) ::
else
$(cmt_local_tagfile_MdcTrkRecon) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_MdcTrkRecon); then /bin/rm -f $(cmt_local_tagfile_MdcTrkRecon); fi ; \
	  $(cmtexe) -tag=$(tags) $(MdcTrkRecon_extratags) build tag_makefile >>$(cmt_local_tagfile_MdcTrkRecon)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_MdcTrkRecon)"; \
	  test ! -f $(cmt_local_setup_MdcTrkRecon) || \rm -f $(cmt_local_setup_MdcTrkRecon); \
	  trap '\rm -f $(cmt_local_setup_MdcTrkRecon)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(MdcTrkRecon_extratags) show setup >$(cmt_local_setup_MdcTrkRecon) && \
	  if [ -f $(cmt_final_setup_MdcTrkRecon) ] && \
	    \cmp -s $(cmt_final_setup_MdcTrkRecon) $(cmt_local_setup_MdcTrkRecon); then \
	    \rm $(cmt_local_setup_MdcTrkRecon); else \
	    \mv -f $(cmt_local_setup_MdcTrkRecon) $(cmt_final_setup_MdcTrkRecon); fi
...
not_MdcTrkRecon_dependencies = { n=0; for p in $?; do m=0; for d in $(MdcTrkRecon_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
MdcTrkRecondirs :
	@if test ! -d $(bin)MdcTrkRecon; then $(mkdir) -p $(bin)MdcTrkRecon; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)MdcTrkRecon
else
MdcTrkRecondirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)MdcTrkRecon
#
#$(cmt_local_MdcTrkRecon_makefile) :: $(MdcTrkRecon_dependencies) $(cmt_local_tagfile_MdcTrkRecon) build_library_links dirs MdcTrkRecondirs
#else
#$(cmt_local_MdcTrkRecon_makefile) :: $(MdcTrkRecon_dependencies) $(cmt_local_tagfile_MdcTrkRecon) build_library_links dirs
#endif
#else
#$(cmt_local_MdcTrkRecon_makefile) :: $(cmt_local_tagfile_MdcTrkRecon)
#endif

ifdef cmt_MdcTrkRecon_has_target_tag

ifndef QUICK
$(cmt_local_MdcTrkRecon_makefile) : $(MdcTrkRecon_dependencies) build_library_links
	$(echo) "(constituents.make) Building MdcTrkRecon.make"; \
	  $(cmtexe) -tag=$(tags) $(MdcTrkRecon_extratags) build constituent_config -out=$(cmt_local_MdcTrkRecon_makefile) MdcTrkRecon
else
$(cmt_local_MdcTrkRecon_makefile) : $(MdcTrkRecon_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_MdcTrkRecon) ] || \
	  [ ! -f $(cmt_final_setup_MdcTrkRecon) ] || \
	  $(not_MdcTrkRecon_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building MdcTrkRecon.make"; \
	  $(cmtexe) -tag=$(tags) $(MdcTrkRecon_extratags) build constituent_config -out=$(cmt_local_MdcTrkRecon_makefile) MdcTrkRecon; \
	  fi
endif
...
$(cmt_local_MdcTrkRecon_makefile) : $(MdcTrkRecon_dependencies) build_library_links
	$(echo) "(constituents.make) Building MdcTrkRecon.make"; \
	  $(cmtexe) -f=$(bin)MdcTrkRecon.in -tag=$(tags) $(MdcTrkRecon_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_MdcTrkRecon_makefile) MdcTrkRecon
else
$(cmt_local_MdcTrkRecon_makefile) : $(MdcTrkRecon_dependencies) $(cmt_build_library_linksstamp) $(bin)MdcTrkRecon.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_MdcTrkRecon) ] || \
	  [ ! -f $(cmt_final_setup_MdcTrkRecon) ] || \
	  $(not_MdcTrkRecon_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(MdcTrkRecon_extratags) build constituent_makefile -out=$(cmt_local_MdcTrkRecon_makefile) MdcTrkRecon

MdcTrkRecon :: $(MdcTrkRecon_dependencies) $(cmt_local_MdcTrkRecon_makefile) dirs MdcTrkRecondirs
	$(echo) "(constituents.make) Starting MdcTrkRecon"
	@if test -f $(cmt_local_MdcTrkRecon_makefile); then \
	  $(MAKE) -f $(cmt_local_MdcTrkRecon_makefile) MdcTrkRecon; \
	  fi
#	@$(MAKE) -f $(cmt_local_MdcTrkRecon_makefile) MdcTrkRecon
	$(echo) "(constituents.make) MdcTrkRecon done"

clean :: MdcTrkReconclean

MdcTrkReconclean :: $(MdcTrkReconclean_dependencies) ##$(cmt_local_MdcTrkRecon_makefile)
	$(echo) "(constituents.make) Starting MdcTrkReconclean"
	@-if test -f $(cmt_local_MdcTrkRecon_makefile); then \
	  $(MAKE) -f $(cmt_local_MdcTrkRecon_makefile) MdcTrkReconclean; \
	fi
	$(echo) "(constituents.make) MdcTrkReconclean done"
#	@-$(MAKE) -f $(cmt_local_MdcTrkRecon_makefile) MdcTrkReconclean

##	  /bin/rm -f $(cmt_local_MdcTrkRecon_makefile) $(bin)MdcTrkRecon_dependencies.make

install :: MdcTrkReconinstall

MdcTrkReconinstall :: $(MdcTrkRecon_dependencies) $(cmt_local_MdcTrkRecon_makefile)
	$(echo) "(constituents.make) Starting install MdcTrkRecon"
	@-$(MAKE) -f $(cmt_local_MdcTrkRecon_makefile) install
	$(echo) "(constituents.make) install MdcTrkRecon done"

uninstall : MdcTrkReconuninstall

$(foreach d,$(MdcTrkRecon_dependencies),$(eval $(d)uninstall_dependencies += MdcTrkReconuninstall))

MdcTrkReconuninstall : $(MdcTrkReconuninstall_dependencies) ##$(cmt_local_MdcTrkRecon_makefile)
	$(echo) "(constituents.make) Starting uninstall MdcTrkRecon"
	@if test -f $(cmt_local_MdcTrkRecon_makefile); then \
	  $(MAKE) -f $(cmt_local_MdcTrkRecon_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_MdcTrkRecon_makefile) uninstall
	$(echo) "(constituents.make) uninstall MdcTrkRecon done"

remove_library_links :: MdcTrkReconuninstall
...
#cmt_local_tagfile_config = $(MdcTrkRecon_tag)_config.make
cmt_local_tagfile_config = $(bin)$(MdcTrkRecon_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)MdcTrkRecon_configsetup.make
...
#cmt_local_tagfile_config = $(MdcTrkRecon_tag).make
cmt_local_tagfile_config = $(bin)$(MdcTrkRecon_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)MdcTrkReconsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(MdcTrkRecon_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(MdcTrkRecon_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)MdcTrkRecon_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(MdcTrkRecon_tag).make
cmt_local_tagfile_install_includes = $(bin)$(MdcTrkRecon_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)MdcTrkReconsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(MdcTrkRecon_tag)_make.make
cmt_local_tagfile_make = $(bin)$(MdcTrkRecon_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)MdcTrkRecon_makesetup.make
...
#cmt_local_tagfile_make = $(MdcTrkRecon_tag).make
cmt_local_tagfile_make = $(bin)$(MdcTrkRecon_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)MdcTrkReconsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(MdcTrkRecon_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(MdcTrkRecon_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)MdcTrkRecon_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(MdcTrkRecon_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(MdcTrkRecon_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)MdcTrkReconsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(MdcTrkRecon_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(MdcTrkRecon_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)MdcTrkRecon_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(MdcTrkRecon_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(MdcTrkRecon_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)MdcTrkReconsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(MdcTrkRecon_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(MdcTrkRecon_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)MdcTrkRecon_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(MdcTrkRecon_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(MdcTrkRecon_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)MdcTrkReconsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(MdcTrkRecon_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(MdcTrkRecon_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)MdcTrkRecon_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(MdcTrkRecon_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(MdcTrkRecon_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)MdcTrkReconsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(MdcTrkRecon_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(MdcTrkRecon_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)MdcTrkRecon_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(MdcTrkRecon_tag).make
cmt_local_tagfile_TestProject = $(bin)$(MdcTrkRecon_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)MdcTrkReconsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(MdcTrkRecon_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(MdcTrkRecon_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)MdcTrkRecon_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(MdcTrkRecon_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(MdcTrkRecon_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)MdcTrkReconsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(MdcTrkRecon_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(MdcTrkRecon_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)MdcTrkRecon_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(MdcTrkRecon_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(MdcTrkRecon_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)MdcTrkReconsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
